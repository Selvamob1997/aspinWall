...
import '../../data/Model/TotalPermisionModel.dart';
...
class PermisionMasterController extends GetxController{
  ...
  postSave(formid){
    ...
    }else if( (TotalPermision+(double.parse(totalTime.text.toString())))>0.59 ){
      Utilities.showDialaogboxWarningMessage(context, "Permision Time Cross the 0.59 ", 'Notification');
    }
    else{
