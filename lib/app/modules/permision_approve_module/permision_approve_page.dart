...
class PermisionApprovePage extends GetView<PermisionApproveController> {
  @override
  Widget build(BuildContext context)=>GetBuilder<PermisionApproveController>(builder: (myController) {
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(
                                      width: width/3.5,
                                      child: Text(myController.secScreenData[index].purposeVisit.toString())),
                                ],
                              ),
                            ),
